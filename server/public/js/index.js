...
// import './class/test'
// import {A,test,Hello} from "./class/lesson11";

// import Lesson11 from './class/lesson11';
//
// console.log(Lesson11.A);
// let hi = new Lesson11.Hello();
// console.log(hi.sayHello());
// console.log(Lesson11.test());
...
var Lottery = function (_mix) {
    ...
    function Lottery() {
        var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'cyy';
    ...
    _createClass(Lottery, [{
        ...
        value: function updateState() {
            ...
            self.getState().then(function (res) {
                ...
                _this2.countdown(_this2.end_time, function (time) {
                    (0, _jquery2.default)(_this2.coundown_el).html(time);
                }, function () {
                    setTimeout(function () {
                        _this2.updateState();
        ...
        value: function initEvent() {
            ...
            (0, _jquery2.default)('.qkmethod').on('click', '.btn-middle', function (e) {
                return _this3.getRandomCode(e);
            });
            (0, _jquery2.default)('.lnk-calcel').on('click', function (e) {
                return _this3.cancelCode(e);
            });
...
var Base = function () {
    ...
    _createClass(Base, [{
        ...
        value: function assistHandle(e) {
            ...
            switch (index) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    (0, _jquery2.default)('.btn-boll .btn-boll').each(function (index, item) {
                        if (item.textContent % 2 === 0) {
                            (0, _jquery2.default)(item).addClass('btn-boll-active');
                        }
                    });
        ...
        value: function addCode() {
            ...
            var active = $active.length ? $active.length : 0;
        ...
        value: function cancelCode(e) {
            ...
            (0, _jquery2.default)('.boll-list .btn-boll-active').removeClass('btn-boll-active');
            this.getCount();
        }
    }, {
        key: 'addCodeItem',
        ...
        key: 'clearCodeItems',
        value: function clearCodeItems() {
            console.log('ssss');
            (0, _jquery2.default)(self.cart_el).empty();
        }
    }, {
        key: 'getCount',
        ...
        value: function getRandomCode(e) {
            e.preventDefault();
            var num = parseInt(e.currentTarget.getAttribute('count'));
            var play = this.cur_play.match(/\d+/g)[0];
            var self = this;
            console.log('$$$$$$$$$$$4   ' + (typeof num === 'undefined' ? 'undefined' : _typeof(num)));
            if (num === 0) {
                console.log('$$$$$$$$$$$4');
                // $(self.cart_el).empty();
...
var Calculate = function () {
    ...
    _createClass(Calculate, [{
        ...
        value: function computeCount(active, play_name) {
            ...
            if (exist && play_name.startsWith('r')) {
